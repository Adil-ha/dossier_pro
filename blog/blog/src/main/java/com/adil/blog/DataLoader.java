...
public class DataLoader implements CommandLineRunner {
    ...
    @Autowired
    public DataLoader(UserRepository userRepository, CategoryRepository categoryRepository, ArticleRepository articleRepository, CommentRepository commentRepository) {
