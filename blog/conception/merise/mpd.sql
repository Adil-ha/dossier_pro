...
CREATE TABLE T_Comment (
    ...
    Co_created_at DATE NOT NULL,
    U_id INT NOT NULL,
    A_id INT NOT NULL,
    PRIMARY KEY (Co_id),
    FOREIGN KEY (U_id) REFERENCES T_User (U_id),
    FOREIGN KEY (A_id) REFERENCES T_Article (A_id)
);

CREATE TABLE T_Jwt (
    T_id INT,
    J_value VARCHAR(50),
    J_is_disable LOGICAL,
    J_is_expirate LOGICAL,
    U_id INT NOT NULL,
    PRIMARY KEY (T_id),
    FOREIGN KEY (U_id) REFERENCES T_User (U_id)
);
...
VALUES (
    ...
    (
        'Conseils pour prendre soin de votre chat',
        'cat.jpg',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
        '2024-04-25',
        2
    ...
    (
        'Guide pour choisir le bon perroquet',
        'parrot.jpg',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
        '2024-04-20',
        1
...
VALUES (
        'Super article ! J\'ai appris beaucoup sur les chiens.',
        '2024-05-03',
        2,
        1
    ),
    ...
    (
        'Je suis passionné par les perroquets, merci pour ce guide.',
        '2024-04-22',
        2,
        3
    );
